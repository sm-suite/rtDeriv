...
class MyWindow:
	def __init__(self, win):
		...
		self.btn4=Button(win, text='2 charts')
		self.b4=Button(win, text='2 charts', width='6', height='2', fg='blue', bg='blue', command=self.view2)
		self.b4.place(x=50, y=20)

		self.btn5=Button(win, text='4 charts')
		self.b5=Button(win, text='4 charts', width='6', height='2', fg='blue', bg='blue', command=self.view4)
		self.b5.place(x=50, y=90)

		self.btn6=Button(win, text='6 charts')
		self.b6=Button(win, text='6 charts', width='6', height='2', fg='blue', bg='blue', command=self.view6)
		self.b6.place(x=50, y=160)

	if dType == 'tp':
		def view2(self):
			from view2 import view2tp
			view2tp()
		def view4(self):
			from view4 import view4tp
			view4tp()
		def view6(self):
			from view6 import view6tp
			view6tp()
	elif dType == 'option':
		def view2(self):
